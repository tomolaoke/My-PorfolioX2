          ...
          <motion.div className="space-y-6" style={{ opacity: textOpacity, y: textY }}>
            <div className="text-black-500 max-w-lg">
              ...
              <motion.p
                ...
                viewport={{ once: true }}
              >
                My real tech transitioning journey started in and around 2024, I began my journey as a software engineer in , and since then, I've continued to grow and evolve as
