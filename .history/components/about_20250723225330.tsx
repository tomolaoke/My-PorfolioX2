          ...
          <motion.div className="space-y-6" style={{ opacity: textOpacity, y: textY }}>
            <div className="text-black-500 max-w-lg">
              ...
              >
                ...
                I am very enthusiastic about bringing the best out of myself and my team to life. Writing clear, readable,
                projects, and I believe that every little detail in my code matters to me.
              </motion.p>
              <motion.p
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
