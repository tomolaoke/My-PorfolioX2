          ...
          <motion.div className="space-y-6" variants={containerVariants}>
            ...
            <motion.div className="space-y-4" variants={containerVariants}>
              <motion.div variants={itemVariants}>
                ...
                <p className="text-muted-foreground">tommola.oke@gmail.com</p>
                <p className="text-muted-foreground">tomola.oke@verdac.tech</p>
              </motion.div>
              ...
              <motion.div variants={itemVariants}>
                ...
                <div className="flex items-center space-x-4 mt-2">
                  {[
                    ...
                    { href: "https://x.com/eda__xx", icon: <Twitter className="w-5 h-5" />, label: "X" }, // { href: "https://twitter.com/eda__xx", icon: <Twitter className="w-5 h-5" />, label: "Twitter" },
                  ].map((social) => (
