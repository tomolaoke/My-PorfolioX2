          ...
          <motion.div className="space-y-6" style={{ opacity: textOpacity, y: textY }}>
            <div className="text-black-500 max-w-lg">
              ...
              >
                ...
                and integrated APIs. I also don't brag as I still don't consider myself a fully proper Software Developer as i am. I am very enthusiastic about bringing the
