...
const reviews = [
  {
    ...
    content:
      "Learning and Working with Tommy as colleague and on an hackathon project was a great experience. His technical expertise and attention to detail resulted in an outstanding product.",
  },
  {
    name: "Praise",
    role: "UI Designer",
